  ...
  return (
    ...
    >
      <div className="flex items-center flex-1 pl-4" style={{ marginLeft: `${indentMargin}px` }}>
        ...
        <div className="flex items-center justify-center flex-shrink-0 rounded overflow-hidden bg-muted h-5 w-9 ml-3">
